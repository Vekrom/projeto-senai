...
export default function EsqueciSenhaFuncionario() {
  ...
  const handleEnviar = async (e) => {
    e.preventDefault();
    try {
      await api.post('/esqueci-senha', { usuario, tipo: 'funcionario' });
  ...
  return (
    <div className="max-w-md mx-auto mt-10 bg-white p-6 rounded shadow">
      <h2 className="text-xl font-bold mb-4 text-center">Recuperar senha - Funcionário</h2>
